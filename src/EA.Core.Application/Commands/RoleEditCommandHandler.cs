...
{
    public class RoleEditCommandHandler : CommandHandler, IRequestHandler<RoleEditCommand, ValidationResult>
    {
        ...
        public async Task<ValidationResult> Handle(RoleEditCommand request, CancellationToken cancellationToken)
        {
