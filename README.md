...
```
cd existing_repo
git remote add origin http://git.easternsun.vn/code-starter/net-api-starter.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.easternsun.vn/code-starter/net-api-starter/-/settings/integrations)
